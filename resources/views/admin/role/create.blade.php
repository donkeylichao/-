...
<div class="main-container" id="main-container">
	...
	<div class="main-content">
		...
		<div class="page-content">
			...
			<form method="post" action="{{ url('donkey/admin/role/store')}}">
				...
				<div class="form-group">
					...
					<div class="col-sm-11">
						<input type="text" name="display_name"  class="col-xs-10 col-sm-4" value="{{ old('display_name') }}"/>
						<span class="help-inline col-xs-12 col-sm-7">
				...
				<div class="form-group">
					...
					<div class="col-sm-11">
						<input type='text' name="description" class="col-xs-10 col-sm-4" value="{{ old('description') }}"/>
						<span class="help-inline col-xs-12 col-sm-7">
							<span class="middle" style="color:red">*必填*</span>
						</span>
					</div>	
