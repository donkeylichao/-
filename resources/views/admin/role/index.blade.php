						...
						<tr>
							...
							<td>
								<div class="btn-group">
                                    ...
                                    <a class="btn btn-xs btn-default" href="{{ url('donkey/admin/role/show') .'/'. $item->id }}">
                                        <i class="ace-icon fa fa-wrench bigger-120"></i>
                                    </a>

									<a class="btn btn-xs btn-info" href="{{ url('donkey/admin/role/edit') .'/'. $item->id }}">
										<i class="ace-icon fa fa-pencil bigger-120"></i>
									</a>

									<a class="btn btn-xs btn-danger" href="{{ url('donkey/admin/role/destroy') .'/'. $item->id}}">
