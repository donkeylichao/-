	...
	<div class="main-content">
		...
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li class="active">日记列表</li>
			</ul><!-- /.breadcrumb -->

			<!-- #section:basics/content.searchbox -->
			<div class="nav-search" id="nav-search">
				<form class="form-search" method="get" action="{{ url('donkey/admin/post/index') }}">
		...
		<div class="page-content">
			...
			<div>
				...
				<a class="btn btn-xs btn-info" href="{{ url('donkey/admin/post/create') }}" style="float:right; margin-bottom:5px;" >
					<i class="ace-icon fa fa-plus bigger-120"></i>写日记
				</a>
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									<a class="btn btn-xs btn-info" href="{{ url('donkey/admin/post/edit') .'/'. $item->id }}" title="编辑">
										<i class="ace-icon fa fa-pencil bigger-120"></i>
									</a>

									<a class="btn btn-xs btn-danger" href="{{ url('donkey/admin/post/destroy') .'/'. $item->id }}" title="删除">
