...
<div class="main-container" id="main-container">
	...
	<div class="main-content">
		...
		<div class="page-content">
			...
			<form method="post" action="{{ url('donkey/admin/emoji/update')}}" enctype="multipart/form-data">
				
				<div class="form-group">
					<label class="col-sm-1 control-label no-padding-right">名称：</label>
					<div class="col-sm-11">
						<input type='text' name='name' class="col-xs-10 col-sm-4" value="{{ old('name') ? old('name') : $emoji->name}}"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-11">
						<input type="text" name="mark"  class="col-xs-10 col-sm-4" value="{{ old('mark') ? old('mark') : $emoji->mark}}"/>
						<span class="help-inline col-xs-12 col-sm-7">
							<span class="middle" style="color:red">*必填*</span>
						</span> 
					</div>
				...
				<div class="form-group">
					<label class="col-sm-1 control-label no-padding-right">表情：</label>
					<div class="col-sm-11">
						<img src="{{ $emoji->path }}"/>
					</div>
				</div>
