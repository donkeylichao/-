...
<div class="main-container" id="main-container">
	...
	<div class="main-content">
		...
		<div class="page-content">
			...
			<form  action="{{ url('donkey/admin/category/store')}}" method="post" role="form">
				<div class="form-group">
					<label class="col-sm-1 control-label no-padding-right">类型：</label>
					<div class="col-sm-11">
						<select name="pid" id="house_type" class="col-xs-10 col-sm-4">
							<option value="0" >--创建根分类--</option>
				...
				<div class="form-group">
					<label class="col-sm-1 control-label no-padding-right">分类名称：</label>
					<div class="col-sm-11">
						<input type='text' name='name' placeholder="请输入分类名称" class="col-xs-10 col-sm-4" value="{{ old('name') }}"/>
						<span class="help-inline col-xs-12 col-sm-7">
