	...
	<div class="main-content">
		...
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<div class="nav-search" id="nav-search">
				<form class="form-search" method="get" action="{{ url('donkey/admin/pdf/index') }}">
					<span class="input-icon">
						<input type="text" placeholder="输入文件名称搜索" class="nav-search-input" id="nav-search-input" name="title"/>
		...
		<div class="page-content">
			...
			<div>
				<a class="btn btn-xs btn-success" href="{{ url('donkey/admin/pdf/create_type') }}" style="float:right; margin-bottom:5px;" >
					<i class="ace-icon fa fa-plus bigger-120"></i>添加类型
				</a>
				<a class="btn btn-xs btn-info" href="{{ url('donkey/admin/pdf/create') }}" style="float:right; margin-bottom:5px;" >
					<i class="ace-icon fa fa-plus bigger-120"></i>上传文件
				</a>
						...
						<tr>
							...
							<td>
								<div class="btn-group">
									...
									<!--<a class="btn btn-xs btn-info" href="{{ url('donkey/admin/pdf/edit') .'/'. $item->id }}" title="编辑">
										<i class="ace-icon fa fa-pencil bigger-120"></i>
									</a>-->

									<a class="btn btn-xs btn-danger" href="{{ url('donkey/admin/pdf/destroy') .'/'. $item->id }}" title="删除">
